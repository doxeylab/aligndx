"""Add customers, subs, invoices table

Revision ID: 4a4feed5fd9c
Revises: 26ac9eb27529
Create Date: 2022-03-05 15:29:55.572064
...
def upgrade():
    ...
    sa.Column('stripe_latest_subscription_id', sa.String(length=50), nullable=False),
    ...
    sa.Column('stripe_invoice_url', sa.String(length=50), nullable=True),
    sa.Column('stripe_payment_receipt_url', sa.String(length=50), nullable=True),
