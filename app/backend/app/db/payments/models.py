...
subscriptions = Table(
    ...
    Column("stripe_price_id", String(50), nullable=False),
...
invoices = Table(
    ...
    Column("id", Integer, primary_key=True),
    Column("status", String(50), nullable=False),
    Column("amount_due", Integer, nullable=False),
    ...
    Column("stripe_invoice_url", String(200), nullable=True),
    Column("stripe_invoice_number", String(50), nullable=True),
    Column("stripe_payment_receipt_url", String(200), nullable=True),
